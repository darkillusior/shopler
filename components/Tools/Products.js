...
function Product({ setProduct,setFiles,product,setMoreproducts,files}) {
  ...
  return (
    ...
    <h2 className='m-2 p-2 text-base  sm:text-2xl font-serif font-semibold text-slate-700 '>Items Added:<span className='m-2 p-2 text-2xl font-sans font-bold text-red-600'>{count}</span></h2> 
    <hr/>

    <div className=' m-2 p-2'> 
    <label className=' text-base  sm:text-xl text-gray-600 font-serif font-semibold'>Product Image:</label><br/>  
     <input   className='' type="file"  name="files"  onChange={onchange} />
     </div>   
     <hr/> 

     <div className=' m-2'>
      <label className=' text-base  sm:text-xl text-gray-600 font-serif font-semibold'>Product Name:</label><br/>
      ...
      <div className=' m-2'>
      <label className=' text-base  sm:text-xl text-gray-600 font-serif font-semibold'>Product Description:</label><br/>
      ...
      <div className=' m-2'>
      <label className=' text-base  sm:text-xl text-gray-600 font-serif font-semibold'>Product Price:</label><br/>
      ...
      <div className=' m-2'>
      <label className=' text-base  sm:text-xl text-gray-600 font-serif font-semibold'>Discount Offered:</label><br/>
      ...
      <div className=' m-2'>
      <label className=' text-base  sm:text-xl text-gray-600 font-serif font-semibold'>Product Size(if):</label><br/>
      ...
      <div className='  m-2'>
      <label className=' text-base  sm:text-xl text-gray-600 font-serif font-semibold'>Product Stocks:</label><br/>
    ...
    <button className='text-slate-800  text-base  sm:text-xl p-2 bg-cyan-300 w-1/2 rounded-sm'>Add</button>
     <hr/>   
