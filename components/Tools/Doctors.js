    ...
    return (
        <div>
            <form className=' m-2 flex flex-col' onSubmit={handleSubmit}>
                ...
                <h2 className='m-2 p-2  text-base  sm:text-2xl font-serif font-semibold text-slate-700 '>Doctors Added:<span className='m-2 p-2 text-2xl font-sans font-bold text-red-600'>{count}</span></h2>
                <hr />

                <div className=' m-2 p-2'>
                    <label className=' text-base  sm:text-xl text-gray-600 font-serif font-semibold'>Doctor's Image:</label><br />
                    <input className='' type="file" name="files" onChange={onchange} />
                </div>
                <hr />

                <div className=' m-2'>
                <label className=' text-base  sm:text-xl text-gray-600 font-serif font-semibold'>Doctor's Name:</label><br />
                ...
                <div className=' m-2'>
                    <label className=' text-base  sm:text-xl text-gray-600 font-serif font-semibold'>Fees:</label><br />
