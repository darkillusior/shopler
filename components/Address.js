                ...
                <div className='border'>
                    <div className='flex '>
                        ...
                        <div className='ml-2 flex flex-col'>
                            ...
                            <h2 className='text-black text-base font-bold'>Gaurav bahuguna</h2>
                    ...
                    <button className='bg-[#ffd814] mt-4  h-10 rounded-md text-black font-normal w-full'>Deliver to this address</button>
                    <button className=' shadow-sm mt-4 border  p-2 rounded-md text-black font-normal w-full'>Edit Address</button>
                    <button className=' shadow-sm mt-2 text-sm  border p-2  rounded-md text-gray-900 font-normal w-full'>Add Delivery Instruction</button>
                </div>
