...
function Navbar({ user }) {
  ...
  return (
    <header className='h-14  bg-gradient-to-b from-cyan-700 to-gray-900   flex item-center font-semibold text-2xl font-sans  shadow-black shadow-md '>
      <div className='text-2xl font-semibold text-zinc-200 font-serif flex items-center m-2'>
      ...
      <div className='flex flex-col p-2  '>
        <button className=" text-xl flex m-auto items-center font-semibold  hover:bg-gradient-to-r  hover:cursor-pointer from-gray-500 to-transparent text-zinc-200 font-serif" onClick={() => { setShowProfile(!showProfile) }} >
